        ...
        <div className="tourHero w-[90%] lg:w-[1100px] mx-auto min-h-[50vh] 2xl:min-h-[40vh] 3xl:min-h-[30vh] rounded-3xl mt-10">
            <div className="flex flex-col xl:flex-row space-y-16 xl:space-y-0 xl:justify-between p-6 xl:p-10">
                <div className="w-full xl:w-[65%] text-white space-y-4">
                    <h1 data-aos="fade-up" data-aos-duration="300"  className="text-3xl  lg:text-[65px] leading-tight font-bold">
                        Life Is Adventure Make The Best <br className='block xl:hidden'/> Of It
                    </h1>
                    <p data-aos="fade-up" data-aos-duration="600"  className='text-sm tracking-wide xl:tracking-wider'>
                ...
                <div className="w-full xl:w-[25%]">
                    <div className="group relative rounded-2xl bg-white p-2">
                        ...
                        <div data-aos="fade-up" data-aos-duration="300"  className='absolute -top-5 -left-5 text-white'>
                        ...
                        <div className="space-y-2 mt-4 px-1 py-2">
                            <div data-aos="fade-up" data-aos-duration="600" className="flex justify-between">
                            ...
                            <h6 data-aos="fade-up" data-aos-duration="900" className='group-hover:text-primary duration-150 text-lg font-bold'>
                                Maldives Sightseeing & Adventure Tour
                            </h6>
                            <div data-aos="fade-up" data-aos-duration="1200" className="flex justify-between">
            ...
            <div className="relative -bottom-16 w-[90%]  mx-auto bg-white rounded-2xl p-5 shadow">         
                <div className="flex flex-col xl:flex-row justify-between items-center xl:space-x-5">
                    <div data-aos="fade-up" data-aos-duration="600" className="w-full xl:w-[25%] h-24 flex flex-col justify-center items-center text-secondary-300 rounded-2xl">
                    ...
                    <div data-aos="fade-up" data-aos-duration="900" className="w-full xl:w-[25%] h-24 flex flex-col justify-center items-center text-secondary-300 rounded-2xl">
                        <div className="w-[90%] mx-auto flex items-center space-x-2 mb-2">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1200" className="w-full xl:w-[25%] h-24 flex flex-col justify-center items-center  text-secondary-300 rounded-2xl">
                        <div className="w-[90%] mx-auto flex items-center space-x-2 mb-2">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1500" className="w-full xl:w-[20%] h-24 flex flex-col justify-center items-center rounded-3xl">
