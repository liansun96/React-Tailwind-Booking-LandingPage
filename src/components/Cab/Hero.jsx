            ...
            <div className="w-[500px] h-[400px] bg-white custom-shadow rounded-3xl p-5 -translate-x-1/3">
              ...
              <div className="space-y-8">
                ...
                <div className="flex relative space-x-6">
                  ...
                  <div className="absolute top-[10px] left-[185px] flex justify-center items-center w-10 h-10 rounded-full z-10 bg-black">
                    <CgArrowsExchangeAlt className='text-white text-3xl'/>
                  </div>
                  <div className="w-[50%]">
                    <div class='p-4 border border-secondary-300 rounded-lg relative'>            
                        <p class="absolute -top-5 translate-x-32 translate-y-1/2 bg-white text-sm text-slate-500 px-1">Drop</p>
                        <input type="text" placeholder='              Select location' className='focus:outline-none w-[100%]' />
                    </div>
                  </div>
                </div>   
                <div className="flex space-x-6">
                  ...
                  <div className="w-[50%]">
                    <div class='p-4 border border-secondary-300 rounded-lg relative'>            
                        <p class="absolute -top-5 translate-x-20 translate-y-1/2 bg-white text-sm text-slate-500 px-1">Pickup Time</p>
                        <input type="text" placeholder='                     Select time' className='focus:outline-none w-[100%]' />
                    </div>
                  </div>
                </div>
