...
const ChooseUs = () => {
  return (
    <div className='w-[90%] lg:w-[1100px] mx-auto 2xl:h-[70vh] 3xl:h-[50vh]'>
        <h1 data-aos="fade-right" data-aos-duration="300" className="text-3xl 2xl:text-5xl my-10 leading-tight text-center font-bold">
            Why Choose Us         
        </h1>
        <div className="flex flex-col xl:flex-row space-y-4 xl:space-y-0 justify-between">
            <div data-aos="fade-right" data-aos-duration="600" className="w-full xl:w-[31.5%] group">
                <div className="custom-shadow-sm group-hover:custom-shadow group-hover:-translate-y-3 group-hover:scale-[104%] duration-500 rounded-xl space-y-4 p-5">
                    <div className="w-[60px] h-[60px] group-hover:rotate-[360deg] group-hover:translate-x-[120px] duration-700 rounded-full flex justify-center items-center bg-[#dddbf7]">
            ...
            <div data-aos="fade-right" data-aos-duration="900" className="w-full xl:w-[31.5%] group">
                <div className="custom-shadow-sm group-hover:custom-shadow group-hover:-translate-y-3 group-hover:scale-[104%] duration-500 rounded-xl space-y-4 p-5">
                    <div className="w-[60px] h-[60px] group-hover:rotate-[360deg] group-hover:translate-x-[120px] duration-700 rounded-full flex justify-center items-center bg-[#e6f8f3]">
            ...
            <div data-aos="fade-right" data-aos-duration="1200" className="w-full xl:w-[31.5%] group">
                <div className="custom-shadow-sm group-hover:custom-shadow  group-hover:-translate-y-3 group-hover:scale-[104%] duration-500 rounded-xl space-y-4 p-5">
                    <div className="w-[60px] h-[60px] group-hover:rotate-[360deg] group-hover:translate-x-[120px] duration-700 rounded-full flex justify-center items-center bg-[#fef6e0]">
        ...
        <div className="flex flex-col xl:flex-row space-y-4 xl:space-y-0 justify-between">
            <div data-aos="fade-right" data-aos-duration="1500" className="w-full xl:w-[31.5%] group">
                <div className="custom-shadow-sm group-hover:custom-shadow  group-hover:translate-y-3 group-hover:scale-[104%] first:duration-300 rounded-xl space-y-4 p-5">
                    <div className="w-[60px] h-[60px] group-hover:rotate-[360deg] group-hover:translate-x-[120px] duration-700 rounded-full flex justify-center items-center bg-[#fbe9eb]">
            ...
            <div data-aos="fade-right" data-aos-duration="1800" className="w-full xl:w-[31.5%] group">
                <div className="custom-shadow-sm group-hover:custom-shadow  group-hover:translate-y-3 group-hover:scale-[104%] duration-500 rounded-xl space-y-4 p-5">
                    <div className="w-[60px] h-[60px] group-hover:rotate-[360deg] group-hover:translate-x-[120px] duration-700 rounded-full flex justify-center items-center bg-[#fff2e7]">
            ...
            <div data-aos="fade-right" data-aos-duration="2100" className="w-full xl:w-[31.5%] group">
                <div className="custom-shadow-sm group-hover:custom-shadow  group-hover:translate-y-3 group-hover:scale-[104%] duration-500 rounded-xl space-y-4 p-5">
                    <div className="w-[60px] h-[60px] group-hover:rotate-[360deg] group-hover:translate-x-[120px] duration-700 rounded-full flex justify-center items-center bg-[#e7f6f8]">
