  ...
  return (
    <div className="w-[90%] lg:w-[1100px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row space-y-8 justify-between items-center">
            <div data-aos="fade-right" data-aos-duration="500" className="lg:w-[23.5%] overflow-hidden mt-8">
            ...
            <div data-aos="fade-right" data-aos-duration="1000" className="lg:w-[23.5%] overflow-hidden">
                <div className="featuredCard relative overflow-hidden rounded-2xl">
                    <div className="rounded-2xl overflow-hidden">
            ...
            <div data-aos="fade-right" data-aos-duration="1500" className="lg:w-[23.5%] overflow-hidden">
                <div className="featuredCard relative overflow-hidden rounded-2xl">
                    <div className="rounded-2xl overflow-hidden">
            ...
            <div data-aos="fade-right" data-aos-duration="2000" className="lg:w-[23.5%] overflow-hidden">
                <div className="featuredCard relative overflow-hidden rounded-2xl">
                    <div className="rounded-2xl overflow-hidden">
