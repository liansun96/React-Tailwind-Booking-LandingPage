...
const TextContainer2 = () => {    
  ...
  return (
    <div className="w-[98%] lg:w-[50%] space-y-6 lg:space-y-10 lg:my-10 lg:pl-6">
        ...
        <div data-aos="fade-up" className="flex flex-col lg:flex-row justify-between items-start space-y-10 lg:space-y-4 lg:space-x-4">
        ...
        <div data-aos="fade-up" className="flex flex-col lg:flex-row justify-between items-center space-y-10 lg:space-y-4 lg:space-x-4">
            <div className="lg:w-[50%] mt-4 group">
