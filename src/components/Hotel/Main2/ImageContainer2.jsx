  ...
  return (
    <div className='w-[100%] lg:w-[50%]'>
        <div className="mb-10 relative float-left">
            <img data-aos="fade-up" src={Hero2} className="lg:w-[85%]  rounded-lg" alt="" />            
            <div data-aos="fade-up" className="absolute -top-[40px] -left-[30px]">
            ...
            <div data-aos="fade-up" className="hidden lg:block absolute scale-[86%] lg:scale-100 -bottom-[60px] -right-[40px] lg:-bottom-[45px] lg:right-[45px] -z-10 ">
