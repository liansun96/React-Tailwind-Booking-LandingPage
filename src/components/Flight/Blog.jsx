...
const Blog = () => {
  return (
    <div className='w-[90%] lg:w-[1100px] mx-auto'>
        <h1 data-aos="zoom-in-up" data-aos-duration="300" className="text-3xl 2xl:text-5xl my-8 leading-tight text-center font-bold">
            Latest Blog & News         
        </h1>
        <div className="flex flex-col xl:flex-row 2xl:flex-row xl:space-x-16 2xl:space-x-16">
            <div className="w-full mb-10 2xl:w-[50%] 2xl:mb-0">
                <div className="group">
                    <img data-aos="zoom-in-up" data-aos-duration="600" src={blogImg1} className="rounded-2xl mb-4" alt="" />
                    <h4 data-aos="zoom-in-up" data-aos-duration="900" className='text-2xl 2xl:text-3xl font-bold duration-200 group-hover:text-primary'>
            ...
            <div className="w-full 2xl:w-[50%]">
                <div className="flex flex-col justify-center items-center space-y-9">
                    <div className="group flex flex-col xl:flex-row 2xl:flex-row items-start lg:items-center space-x-4">
                        <div data-aos="zoom-in-up" data-aos-duration="600" className="w-full xl:w-[30%] 2xl:w-[30%]">
                            <img src={blogImg2} className="rounded-2xl mb-4" alt="" />
                        </div>
                        <div data-aos="zoom-in-up" data-aos-duration="900" className="w-full 2xl:w-[70%] space-y-2">
