  ...
  return (
    <div className="relative mt-0 2xl:mt-10">
      <div className="hero flex flex-col space-y-4 justify-around  items-center w-[90%] lg:w-[1100px] bg-black rounded-3xl min-h-[120vh]  xl:min-h-[70vh] 2xl:min-h-[70vh]  3xl:min-h-[45vh] mx-auto">
        ...
        <div className="relative w-[85%] mi-h-[23vh] 2xl:h-[32vh] 3xl:h-[23vh] 4xl:h-[18vh] mx-auto bg-white bg-opacity-60 rounded-lg p-5 py-8">
          <div className="flex flex-col xl:flex-row 2xl:flex-row justify-between items-center">
            <div className="w-full xl:w-[25%] 2xl:w-[25%] flex px-[2px] py-[2px] rounded-xl border-2 border-black mb-6 lg:mb-0">
            ...
            <div className="w-full xl:w-[50%] 2xl:w-[50%] flex flex-col space-y-6 lg:space-y-0 xl:flex-row 2xl:flex-row justify-between text-secondary-300">
              <div className="w-full xl:w-[45%] 2xl:w-[45%] h-10 p-2 px-4 flex justify-between items-center rounded-lg bg-secondary-400 custom-shadow-sm">
                <p>Select Class</p>
                <FiChevronDown />
              </div>
              <div className="w-full xl:w-[45%] 2xl:w-[45%] h-10 p-2 px-4 flex justify-between items-center rounded-lg bg-secondary-400 custom-shadow-sm">
          ...
          <div className="flex flex-col  space-y-6 lg:space-y-0 xl:flex-row 2xl:flex-row justify-between items-center mt-8">
            <div className="w-full xl:w-[30%] 2xl:w-[30%] h-24 flex flex-col justify-center items-center bg-secondary-400 custom-shadow-sm text-secondary-300 rounded-2xl">
