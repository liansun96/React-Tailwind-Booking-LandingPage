  ...
  return (
    <div className='w-[90%] lg:w-[1100px] mx-auto'>
        <div className="flex flex-col xl:flex-row 2xl:flex-row justify-around">
            ...
            <div className="w-full 2xl:w-[30%] mt-5">
                <div data-aos="zoom-in-up" data-aos-duration="1500"  className="flex flex-col space-y-3 justify-center items-center">
                    <img src={bkFeatured3} className="w-[50%]" alt="" />
                    <h6 className='text-xl font-bold'>Search Choice</h6>
                    <p className='text-secondary-300 text-sm text-center'>
                        With an easy and fast ticket purchase <br /> process
                    </p>
                </div>
            </div>
        </div>
